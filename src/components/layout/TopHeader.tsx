  ...
  return (
    <header className="sticky top-0 right-0 left-0 border-b border-border-color glass-standard min-h-[72px] flex items-center justify-between px-4 md:px-8 z-20">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="h-4 w-px bg-border-color md:hidden" />
      ...
      <div className="flex items-center gap-1.5 sm:gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 rounded-lg glass-subtle hover:bg-surface-hover text-text-muted hover:text-text-primary text-xs transition-colors border border-border-color cursor-pointer min-h-[36px] min-w-[36px] md:min-w-[180px]"
          aria-label="Open command search"
        >
          <Search className="h-4 w-4 shrink-0" />
          <span className="hidden md:inline font-medium">Search shortcuts...</span>
          <kbd className="hidden lg:inline-flex items-center justify-center h-5 px-1.5 rounded bg-surface-secondary border border-border-color font-sans text-[10px] text-text-muted ml-auto font-medium">
            Ctrl K
          </kbd>
        </button>
