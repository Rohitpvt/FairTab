      ...
      {groups.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {groups.map((group) => (
            <div
              key={group.groupId}
              className="relative overflow-hidden rounded-2xl border border-border-color bg-surface-primary shadow-sm hover:shadow-lg transition-all duration-200 hover:border-[#E2C854]/40 hover:-translate-y-0.5 p-6 group"
            >
              {/* Top Row: Icon/Indicator */}
              <div className="flex justify-between items-start mb-4">
                <div className="p-2.5 bg-[#E2C854]/10 rounded-xl border border-[#E2C854]/20 group-hover:border-[#E2C854]/40 transition-colors">
                  <Users className="h-5 w-5 text-[#E2C854]" />
                </div>
              ...
              {/* Title & Role */}
              <h3 className="text-lg font-bold text-text-primary mb-1 group-hover:text-[#E2C854] transition-colors">
                {group.groupName}
              </h3>
              <div className="flex items-center gap-1 text-xs text-text-muted mb-6">
                <UserCheck className="h-3 w-3 text-[#E2C854]" />
              ...
              <div className="flex items-center justify-between pt-4 border-t border-border-color/60">
                ...
                <Link
                  ...
                  className="flex items-center gap-1 text-xs font-semibold text-[#E2C854] hover:underline"
                >
                  View Details
